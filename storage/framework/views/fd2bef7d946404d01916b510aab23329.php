...
<head>
    ...
    <!-- Owl Carousel -->
    <link rel="stylesheet" href="<?php echo e(asset('blog_template/css/owl.carousel.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('blog_template/css/owl.theme.default.min.css')); ?>">

    <!-- Flaticons  -->
    <link rel="stylesheet" href="<?php echo e(asset('blog_temlate/fonts/flaticon/font/flaticon.css')); ?>">
                    ...
                    <div class="col-md-10 text-right menu-1">
                        <ul>
                            ...
                            <?php if(auth()->guard()->guest()): ?>
                                <li class="btn-cta"><a href="<?php echo e(route('login')); ?>"><span>Sign in</span></a></li>
                            <?php endif; ?>
                ...
                <div class="col-md-3 colorlib-widget">
                    ...
                    <div class="f-blog">
                        <a href="blog.html" class="blog-img"
                           style="background-image: url(blog_template/images//blog-1.jpg);">
                        </a>
                        <div class="desc">
                    ...
                    <div class="f-blog">
                        <a href="blog.html" class="blog-img"
                           style="background-image: url(blog_template/images//blog-2.jpg);">
                        </a>
                        <div class="desc">
                            <h2><a href="blog.html">Creating Mobile Apps</a></h2>
                            <p class="admin"><span>18 April 2018</span></p>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <p>
                            ...
                            <small class="block">Demo blog_template/images/: <a href="http://unsplash.co/"
...
<?php /**PATH /app/project/resources/views/main_layouts/master.blade.php ENDPATH**/ ?>